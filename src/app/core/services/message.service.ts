    ...
    if (error && error.error) {
      ...
      switch (code) {
        case 'INVALID_USERNAME':
          errorMessage = "Korisnik sa unetim korisničkim imenom ne postoji";
          break;
        case 'INVALID_EMAIL':
          errorMessage = "Korisnik sa unetom email adresom ne postoji";
          break;
        case 'INVALID_PASSWORD':
          errorMessage = "Korisnik sa unetom lozinkom ne postoji";
          break;
        ...
        case 'INVALID_YEAR':
          ...
          break;
        case 'DATE_MISMATCH':
          errorMessage = "Datum prve registracije mora biti pre datuma trenutne registracije";
          break;
        ...
        case 'VEHICLE_TYPE_NAME_EXISTS':
          errorMessage = "Tip vozila sa ovom nazivom već postoji";
          break;
